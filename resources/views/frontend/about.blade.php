            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-us_img">
                        <img src="{{asset('frontend/assets/images/banner/about-us_bg.jpg') }}" alt="About Us Image">
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="row testimonial-two">
                                ...
                                <div class="testimonial-wrap-two text-center">
                                    <div class="quote-container">
                                        <div class="quote-image">
                                            <img src="{{asset('frontend/assets/images/testimonial/testimonial-01.jpg') }}" alt="">
                                        </div>
                                        <div class="author">
                                            <h6>Niloba Khan</h6>
                                            <p>CEO of Hasbar</p>
                            ...
                            <div class="col-lg-6 ml-auto mr-auto">
                                <div class="testimonial-wrap-two text-center">
                                    <div class="quote-container">
                                        <div class="quote-image">
                                            <img src="{{asset('frontend/assets/images/testimonial/testimonial-02.jpg') }}" alt="">
                                        </div>
                                        <div class="author">
                                            <h6>Devite oni</h6>
                                            <p>CEO of SunPark</p>
